public class HatchbackCar implements Car{
    ...
    public void allocatingAccessories() {
        System.out.println("Accesories allocated to Hatchback Car");
    }
    @Override
    public void assemble() {
        System.out.println("Assembling Parts For Hatchback Car..");
        System.out.println("Parts Assembled. ");
    }

    @Override
    public void paint() {
        System.out.println("Applying Paint To Your Hatchback Car...");
